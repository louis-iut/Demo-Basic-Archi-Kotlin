...
class MockAPIManagerImpl: APIManager {
    override fun getComics(): Observable<List<RemoteComic>> {
        ...
        val comic1 = RemoteComic("67933", "Captain America (2017) #703", Date(), "http://i.annihil.us/u/prod/marvel/i/mg/9/40/5b0f16c49c83a.jpg", creators, "APR180756")
        val comic2 = RemoteComic("69382", "Rise of the Black Panther (2018) #6", Date(), "http://i.annihil.us/u/prod/marvel/i/mg/6/20/5b0f164800e7e.jpg", creators, "APR180794")
